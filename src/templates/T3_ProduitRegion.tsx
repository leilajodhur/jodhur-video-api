...
// أيقونة الواتساب الخاصة بالمشهد الأخير
const WhatsAppIcon = () => (
  ...
  return (
    <AbsoluteFill style={{ background: '#000' }}>
      ...
      <Sequence from={510} durationInFrames={90}>
        ...
        {/* التعديل الثاني والثالث: الأزرار مرفوعة (Column) مع المنتج البارز في الوسط */}
      ...
      <Sequence from={90} durationInFrames={210}>
        {/* التعديل الرابع: رفعنا الـ TikTok Caption إلى 380 لكي لا تختفي في الأسفل */}
        <TikTokCaption text={props.hookDarija} startFrame={0} rtl={true} animationMode="slide-up" bgColor={COLORS.green} bottom={380} />
      </Sequence>
